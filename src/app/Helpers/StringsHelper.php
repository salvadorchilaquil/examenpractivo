...
function zerofill($folio)
{
    $lenght = strlen ( "$folio" );
    switch($lenght)
    {
        case '1':$pre_folio = "00000";
        break;
        case '2':$pre_folio = "0000";
        break;
        case '3':$pre_folio = "000";
        break;
        case '4':$pre_folio = "00";
        break;
        case '5':$pre_folio = "0";
    ...
    return $pre_folio.$folio;
}

function copyTextConekta($text)
{
    switch($text)
    {
        case 'REALSPEI':$string = "CSPEI";
        break;
        case 'SPEI':$string = "TSPEI";
        break;
        default: $string = $text;
        break;
    }
